...
#define UE_PROJECT_NAME UE_CPP_Tutorial_1
#define UE_TARGET_NAME UE_CPP_Tutorial_1Editor
#define UE_MODULE_NAME "UE_CPP_Tutorial_1"
...
#define UE_CPP_TUTORIAL_1_API DLLEXPORT
